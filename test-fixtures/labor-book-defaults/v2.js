/**
 * Default Labor & Price Book data for Takeoff Tooling.
 * Pure data, no logic. Loaded before js/state.js, which deep-clones
 * LABOR_BOOK_DEFAULTS into its mutable laborBook (user edits are

...
js/views/organize.js   → TakeoffOrganizeView (full-page category organizer)
...
| views/organize.js | `TakeoffOrganizeView` (category organizer board; Apply commits via `TakeoffState.applyBookReorganization`) | TakeoffState, TakeoffApp, TakeoffUtils, McBook (supplier-detach warnings; typeof-guarded) |
